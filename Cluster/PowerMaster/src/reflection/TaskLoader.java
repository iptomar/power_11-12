...
public class TaskLoader extends ClassLoader{
    ...
    public TaskLoader(byte[] array, String name){
        this.ClassName = name;
        this.classObject = createClass(array);
    }
    ...
    public TaskLoader(ClassLoader instance,String localClass){
        super(instance);
        this.ClassName = localClass.replace(".class", "");
     ...
     * @return 
     */
    public Class createClass(byte[] array) {

        Class c = null;

        try {
            //super.
            c = defineClass(this.ClassName, array, 0, array.length);
            resolveClass(c);
            //if (resolve) {
                //resolveClass(c);
